...
public class OffersFragment extends Fragment {
    ...
    String []product_price={"100","200","300","400","500","600","700"};
    int[]imgid={R.drawable.o1,R.drawable.o2,R.drawable.o3,R.drawable.product,R.drawable.o4,R.drawable.women2,R.drawable.men1};
...
// set the transparent color of the status bar, 20% darker
        ...
        lst = v.findViewById(R.id.listview1);
